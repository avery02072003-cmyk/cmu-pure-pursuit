...
% =========================================================================
% 步驟七之後：Off-axle 幾何驗證（M1、L2 是否維持定值）
% =========================================================================
err_M1 = hypot(hist.Hx - hist.x0, hist.Hy - hist.y0) - params.M1;
err_L2 = hypot(hist.Hx - hist.x1, hist.Hy - hist.y1) - params.L2;
fprintf('M1 幾何誤差範圍: [%.6f, %.6f] m\n', min(err_M1), max(err_M1));
fprintf('L2 幾何誤差範圍: [%.6f, %.6f] m\n', min(err_L2), max(err_L2));
